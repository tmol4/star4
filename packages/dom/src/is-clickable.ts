// MIT License
// https://github.com/webdriverio/webdriverio/blob/main/packages/webdriverio/src/scripts/isElementClickable.ts
 ...
 */
export const isElementClickable = (element: HTMLElement): boolean => {
